...
from backend.models import UniversityUser
...
SAMPLE_HEADERS = {
    ...
    "Shib-Identity-Provider":
        "https://sso.college.edu/idp/shibboleth",
    "Shib-Session-ID":
        "1",
    "Shib-Session-Index":
        "12",
    "Shibboleth-affiliation":
        "member@college.edu;staff@college.edu",
    "Shibboleth-schoolBarCode":
        "12345678",
    "Shibboleth-schoolNetId":
        "Sample_Developer",
    "Shibboleth-schoolStatus":
        "active",
    "Shibboleth-department":
        "University Library, Integrated Technology Services",
    "Shibboleth-displayName":
        "Sample Developer",
    "Shibboleth-eppn":
        "sampledeveloper@school.edu",
    "Shibboleth-givenName":
        "Sample",
    "Shibboleth-isMemberOf":
        "SCHOOL:COMMUNITY:EMPLOYEE:ADMINISTRATIVE:BASE;SCHOOL:COMMUNITY:EMPLOYEE:STAFF:SAC:P;COMMUNITY:ALL;SCHOOL:COMMUNITY:EMPLOYEE:STAFF:SAC:M;",
    "Shibboleth-isMemberOf-multi-delimiter":
        "SCHOOL:COMMUNITY:EMPLOYEE:ADMINISTRATIVE:BASE,SCHOOL:COMMUNITY:EMPLOYEE:STAFF:SAC:P,COMMUNITY:ALL;SCHOOL:COMMUNITY:EMPLOYEE:STAFF:SAC:M,",
    "Shibboleth-mail":
        "Sample_Developer@school.edu",
    "Shibboleth-persistent-id":
        "https://sso.college.edu/idp/shibboleth!https://server.college.edu/shibboleth-sp!sk1Z9qKruvXY7JXvsq4GRb8GCUk=",
    "Shibboleth-sn":
        "Developer",
    "Shibboleth-title":
        "Library Developer",
    "Shibboleth-unscoped-affiliation":
        "member;staff",
}
...
settings.AUTH_USER_MODEL = 'backend.UniversityUser'
...
class TestShibbolethRemoteUserBackend(TestCase):
    ...
    def test_create_unknown_user_true(self):
        self.assertFalse(UniversityUser.objects.all())
        ...
        self.assertEqual(
            UniversityUser.objects.all()[0].username,
            'sampledeveloper@school.edu'
        )
    ...
    def test_auth_inactive_user_false(self):
        ...
        UniversityUser.objects.create(
            username='sampledeveloper@school.edu', is_active=False
        )
        user = auth.authenticate(
            remote_user='sampledeveloper@school.edu', shib_meta=shib_meta
        )
    ...
    #     user = UniversityUser.objects.get(username='sampledeveloper@school.edu')
...
class TestShibbolethParseAttributes(TestCase):
    ...
    def test_present_required_attribute(self):
        ...
        self.assertEqual(
            shib_meta["last_name"], SAMPLE_HEADERS["Shibboleth-sn"]
        )
    ...
    def test_mutated_attribute(self):
        ...
        self.assertEqual(
            shib_meta["shortened_name"],
            SAMPLE_HEADERS["Shibboleth-displayName"][:5]
        )
...
#             query = UniversityUser.objects.filter(
#                 username='sampledeveloper@school.edu'
#             )
#             # Ensure the user was created
#             self.assertEqual(len(query), 1)
#             user = UniversityUser.objects.get(
#                 username='sampledeveloper@school.edu'
#             )
...
#     with self.settings(
#         SHIBBOLETH_GROUP_ATTRIBUTES=['Shibboleth-affiliation']
#     ):
#         reload(app_settings)
#         reload(middleware)
#         self.client.get('/', **SAMPLE_HEADERS)
...
#             'Shibboleth-affiliation', 'Shibboleth-isMemberOf'
#         ]
#     ):
#         reload(app_settings)
#         reload(middleware)
